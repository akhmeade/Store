...
//              .jsonPath("$.payments[0].accounts[0].description").isEqualTo("First visit");
//    }
//
//    /**
...
//              .expectBody()
//              .jsonPath("$.payments[0].name").isEqualTo("Garfield")
//              .jsonPath("$.payments[0].accounts").isEmpty();
//    }
